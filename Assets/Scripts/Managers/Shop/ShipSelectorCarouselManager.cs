        ...
        void PlotShipsIntoCarousel(GameObject[] ships, bool displayPriceTag)
        {
            ...
            for (int i = 0; i < ships.Length; i++)
            {
                ...
                if (!displayPriceTag)
                {
                    ...
                    shipInstance.transform.FindChild("Coin").gameObject.SetActive(false);
                }
                ...
                shipInstance.transform.FindChild("ShipButton").GetComponent<Button>().onClick.AddListener(() => shipSelectorManager.SetSelectedObject(ShopSelectedObjectEnum.Ship, shipInstance, shipInstance.GetComponent<Ship>().GetName()));
            }
        }
